/**
 * Created by taupr on 13-01-2016.
 */
...
Sul = [
...

    {
        title: "Kommunikation",
        states: [
            {"Kommunikationsvanskeligheder": {precision: "", comments: []}}
        ]
    },
...

    {
        title: "Cirkulation",
        states: [
            {"Cirkulationsproblem": {precision: "", comments: []}}
        ]
    },

    {
        title: "Seksualitet",
        states: [
            {"Problem vedr.seksualitet/seksuel aktivitet": {precision: "", comments: []}}
        ]
    },
...

    {
        ...
        states: [
            {"Afføringsinkontinens": {precision: "", comments: []}},
