...
angular.module('EOJ', ['databaseservice','main', 'header', 'tabsModule', 'careplan', 'assesment', 'router', 'assignment', 'plan', 'personal', 'dropdown', 'ripple', 'popup', 'sul', 'selectlinkpopup']);
